...
# # batch_size:
# # batch_size --> customer_id, article_id, features_used
# # predict --> customer_id, article_id, scores, -->  customer_id, (article_id, scores) list
# # batch of (customer_id, (article_id, scores) list)
# # output batch
# # merge in the end
# # fix according to article
@timer
def batch_pred(batch_samples,
    ...
    for cid, aids in zip(
        ...
        for aid in aids:
            ...
            info['article_id'] = aid
            features = combine_info_and_get_sampples(
                aid,
                cid,
                article_feature_dict,
                customer_feature_dict,
    ...
    data4pred['score'] = clf.predict_proba(data4pred[features_name])[:, 1]
